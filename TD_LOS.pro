...
radius = make_array(400,400, 357,/double)	;RADIUS OF BOX, FOR EACH FRAME (WILL BE THE SAME)
value = make_array(400,400, 357,/double)	;DIFFERENCE DOPPLERGRAM IN BOX, FOR EACH FRAME
td = make_array(200,/double)
tdtbl1 = make_array(200,357,/double)		
angl = make_array(400,400, 357,/double)		;ANGLE QUAKE IS INSIDE BOX, FROM CENTRE OF BOX, FOR EACH FRAME
box = make_array(400,400,357,/double)		;CREATES BOX AROUND DESIRED REGION, FOR ECH FRAME
...
xstart = 2744.0					;START OF BOX IN X-DIRECTION
xend = 3144.0					;END OF BOX IN X-DIRECTION
ystart = 1434.0					;START OF BOX IN Y-DIRECTION
yend = 1834.0					;END OF BOX IN Y-DIRECTION



;dif=make_array(4096, 4096, 659)	;MAKES AN ARRAY TO BE FILLED BY FOR LOOP 

r=double(0)
savepath='./'

FOR t=0, 355 DO BEGIN &$		;MUST BE ONE LESS THAN MAX FRAME, AS CAN'T REMOVES NEXT FRAME AFTER IT
...
save,tdtbl1,filename=savepath+'HMI_LOS__New_Attempt.idl'
