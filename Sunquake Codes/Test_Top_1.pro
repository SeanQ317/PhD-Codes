...
xstart = 380.0					;START OF BOX IN X-DIRECTION
xend = 780.0					;END OF BOX IN X-DIRECTION
ystart = 318.0					;START OF BOX IN Y-DIRECTION
yend = 718.0					;END OF BOX IN Y-DIRECTION
...
FOR t=80, 100 DO BEGIN &$		;MUST BE ONE LESS THAN MAX FRAME, AS CAN'T REMOVES NEXT FRAME AFTER IT
...
save,tdtbl1,filename=savepath+'Test_Top_1.idl'
