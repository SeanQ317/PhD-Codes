...
xstart = 510.0					;START OF BOX IN X-DIRECTION
xend = 910.0					;END OF BOX IN X-DIRECTION
ystart = 270.0					;START OF BOX IN Y-DIRECTION
yend = 670.0					;END OF BOX IN Y-DIRECTION
...
FOR t=0, 224 DO BEGIN &$		;MUST BE ONE LESS THAN MAX FRAME, AS CAN'T REMOVES NEXT FRAME AFTER IT
	...
	dif[*,*,t]=(v_cog[*, *, t+1])-(v_cog[*, *, t]) &$		;FOR EXAMPLE, FRAME 101-100 
...
save,tdtbl1,filename=savepath+'Time-Dist_Test2.idl'
