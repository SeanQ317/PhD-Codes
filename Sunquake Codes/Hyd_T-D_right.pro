...
restore, 'hyd_v_cog.idl'						;RESTORES DATA
...
xstart = 525.0					;START OF BOX IN X-DIRECTION
xend = 925.0					;END OF BOX IN X-DIRECTION
ystart = 260.0					;START OF BOX IN Y-DIRECTION
yend = 660.0					;END OF BOX IN Y-DIRECTION
...
save,tdtbl1,filename=savepath+'Time-Dist_Hyd_right.idl'
